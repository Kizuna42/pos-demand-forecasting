...
class TestReportGenerator:
    ...
    def test_generate_markdown_report(self, report_generator, sample_analysis_results, sample_quality_report):
        """Markdownレポート生成のテスト"""
    ...
    def test_empty_results_handling(self, report_generator):
        ...
        # エラーが発生しないことを確認
        markdown_report = report_generator.generate_markdown_report(empty_results, empty_quality_report)
        assert isinstance(markdown_report, str)
    ...
    def test_invalid_data_handling(self, report_generator):
        ...
        # エラーが適切に処理されることを確認
        try:
            markdown_report = report_generator.generate_markdown_report(invalid_results, invalid_quality_report)
