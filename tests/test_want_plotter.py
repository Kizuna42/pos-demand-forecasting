...
class TestWantPlotter:
    ...
    def sample_demand_results(self):
        ...
        price_demand_data = pd.DataFrame(
            {"price": [50, 60, 70, 80, 90, 100], "quantity": [75, 70, 65, 60, 55, 50]}
        )
    ...
    def sample_quality_data(self):
        ...
        return {
            "total_products": 10,
            "quality_distribution": {"Premium": 3, "Standard": 4, "Basic": 2, "Rejected": 1},
            ...
            "average_r2": 0.65,
            "r2_std": 0.15,
            "category_success_rates": {"果物": 0.8, "野菜": 0.6, "肉類": 0.7, "魚類": 0.5},
        }
    ...
    def test_create_demand_curve_plot(self, want_plotter, sample_demand_results, temp_dir):
        ...
        result_path = want_plotter.create_demand_curve_plot(sample_demand_results, str(save_path))
    ...
    def test_create_feature_importance_plot(
        self, want_plotter, sample_feature_importance, temp_dir
    ):
        """特徴量重要度プロット作成のテスト"""
    ...
    def test_create_feature_importance_plot_default_path(
        self, want_plotter, sample_feature_importance
    ):
    ...
    def test_create_quality_dashboard(self, want_plotter, sample_quality_data, temp_dir):
        ...
        result_path = want_plotter.create_quality_dashboard(sample_quality_data, str(save_path))
    ...
    def test_create_comprehensive_report_plots(
        self, want_plotter, sample_demand_results, sample_feature_importance, temp_dir
    ):
        """包括的レポートプロット作成のテスト"""
        analysis_results = [
            {
            ...
            {"product_name": "キャベツ", "feature_importance": sample_feature_importance},
        ]

        saved_files = want_plotter.create_comprehensive_report_plots(analysis_results, temp_dir)
    ...
    def test_empty_data_handling(self, want_plotter, temp_dir):
        ...
        result_path = want_plotter.create_quality_dashboard(empty_quality_data, str(save_path))
