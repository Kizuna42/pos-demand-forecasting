...
class TestQualityEvaluator:
    ...
    def test_generate_quality_dashboard_data(self, quality_evaluator, sample_analysis_results):
        ...
        # 必要なキーが存在することを確認
        required_keys = [
            'total_products', 'quality_distribution', 'implementation_distribution',
            'success_rate', 'average_r2', 'r2_std', 'category_success_rates'
        ]
    ...
    def test_create_quality_report(self, quality_evaluator, sample_analysis_results):
        ...
        # レポート構造を確認
        required_keys = ['summary', 'detailed_analysis', 'overall_assessment', 'improvement_priorities']
        for key in required_keys:
