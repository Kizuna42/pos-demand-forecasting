...
class TestDemandCurveAnalyzer:
    ...
    def test_analyze_demand_curve(self, demand_analyzer, sample_data):
        ...
        # 必要なキーが含まれていることを確認
        expected_keys = [
            'product_name', 'optimal_price', 'current_price', 'price_elasticity',
            'demand_curve_function', 'fit_params', 'r2_score', 'price_range',
            'quantity_range', 'data_points', 'price_demand_data'
        ]
    ...
    def test_get_demand_summary(self, demand_analyzer, sample_data):
        ...
        # 必要なキーが含まれていることを確認
        expected_keys = [
            'product_name', 'current_price', 'optimal_price', 'price_change_pct',
            'price_elasticity', 'elasticity_category', 'model_fit_quality', 'data_points'
        ]
