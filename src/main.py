...
class DemandForecastingPipeline:
    ...
    def run_full_analysis(self, target_products: List[str] = None, 
    ...
    def _analyze_single_product(self, product: str, product_data: pd.DataFrame, 
        ...
        try:
            ...
            # 商品カテゴリ取得
            category = product_data['商品カテゴリ'].iloc[0] if '商品カテゴリ' in product_data.columns else 'その他'
    ...
    def _generate_visualizations(self, analysis_results: List[Dict[str, Any]], 
    ...
    def _generate_reports(self, analysis_results: List[Dict[str, Any]], 
                         quality_report: Dict[str, Any]) -> List[str]:
        """レポートを生成"""
        report_files = []
